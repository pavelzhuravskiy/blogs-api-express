...
export const bodyNameValidationMiddleware = body("name")
  .exists()
...
export const bodyDescriptionValidationMiddleware = body("description")
  .exists()
...
export const bodyWebsiteUrlValidationMiddleware = body("websiteUrl")
  .exists()
