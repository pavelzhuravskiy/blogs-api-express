...
exports.validationPostsCreation = void 0;
const express_validator_1 = require("express-validator");
const mongodb_1 = require("mongodb");
const mongodb_blogs_query_repository_1 = require("../../repositories/query-repos/mongodb-blogs-query-repository");
exports.validationPostsCreation = (0, express_validator_1.body)("blogId").custom((value) => __awaiter(void 0, void 0, void 0, function* () {
