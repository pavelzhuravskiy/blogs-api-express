...
exports.validationCommentOwner = void 0;
const mongodb_comments_query_repository_1 = require("../../repositories/query-repos/mongodb-comments-query-repository");
const mongodb_1 = require("mongodb");
const validationCommentOwner = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.validationCommentOwner = validationCommentOwner;
